...
module.exports = function start(list, filename) {
...
return new Promise((resolve, reject) => {
  ...
  const convert = require(path.resolve(process.cwd(), 'convert_sb2_to_sb3.js'));
  ...
  */
  ...
  var text_file = "data/" + filename + ".txt"
  var ids_file = "data/" + filename + ".ids"
  var errors_file = "data/" + filename + ".err"
  ...
  q.drain(function() {
    ...
    //   else {
      ...
      var timer = setInterval(function () {
        ...
        console.dir("q.running: ", q.running());
        console.dir(q.workersList());
